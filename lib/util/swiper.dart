...
class CardAnimation {
  ...
  static Animation<Alignment> frontCardAlign(
    ...
    if (_SwiperCardState._trigger == TriggerDirection.none) {
      endX = beginAlign.x > 0
    ...
    } else if (_SwiperCardState._trigger == TriggerDirection.left) {
      endX = beginAlign.x - swipeEdge;
      endY = beginAlign.y + 0.5;
    }
    /* Trigger Swipe Up or Down */
    else if (_SwiperCardState._trigger == TriggerDirection.up ||
        _SwiperCardState._trigger == TriggerDirection.down) {
      var beginY = _SwiperCardState._trigger == TriggerDirection.up ? -10 : 10;
...
class _SwiperCardState extends State<SwiperCard> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant SwiperCard oldWidget) {
